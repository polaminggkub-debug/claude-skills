...
2. **Ask the user (MANDATORY — do not skip):** "How many audit passes? (1-5, default 1 — suggest 2-3 for critical test suites)". Wait for their answer before proceeding. Do not assume 1 and skip ahead.
